...
class Building(CarbonFootprint):
    def __init__(self):
        ...
        super().__init__(PricePerKWH, ElectricityEmissionFactor, C02Emissions)
    ...
    def getCarbonFootprint(self):
        ...
        return print(
            f'C02 Emissions in Pounds for a Building is : {self.C02Emissions}')
...
class Car(CarbonFootprint):
    def __init__(self):
        ...
        super().__init__(EmissionOfOtherGreenhouseGases,
                         PoundsOfC02EmittedPerGallon, WeeksInAYear,
                         C02Emissions)

        def getCarbonFootprint(self):
            self.C02Emissions = (
                (self.MilesDrivenPerWeek * self.WeeksInAYear) /
                self.FuelEfficiency
            ) * self.PoundsOfC02EmittedPerGallon * self.EmissionsOfOtherGreenhouseGases
            return print(
                f'C02 Emissions in Pounds for a Car is : {self.C02Emissions}')
